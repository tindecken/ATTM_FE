    ...
    >
      ...
      <q-page-container class="q-pa-sm">
        <div class="row q-mb-sm">
          <span class="text-subtitle1" v-if="category && category.TestSuiteIds.length > 0">Are you sure to delete category: {{category.Name}}, and its {{category.TestSuiteIds.length}} test suite(s)?</span>
          <span class="text-subtitle1" v-else>Are you sure to category: {{category.Name}}?</span>
        </div>
