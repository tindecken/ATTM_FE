    ...
    >
      ...
      <q-page-container class="q-pa-sm">
        <div class="row q-mb-sm">
          <span class="text-subtitle1" v-if="testCases.length > 1"
            >Are you sure to delete {{ testCases.length }} test case(s)?</span
          >
          <span class="text-subtitle1" v-else
            >Are you sure to delete test case: {{ testCases[0].CodeName }} -
            {{ testCases[0].Name }}?</span
          >
        </div>
