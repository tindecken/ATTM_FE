  ...
  <q-form autofocus greedy @submit="onSubmit" ref="form">
    <div class="row q-pa-sm">
      ...
      <q-input
        readonly
        :model-value="
          date.formatDate(props.TestEnv.LastModifiedDate, 'YYYY-MM-DD HH:mm:ss')
        "
        label="Last Modified Date"
      />
      <q-input
        readonly
        :model-value="props.TestEnv.LastModifiedMessage"
        label="Last Modified Message"
      />
      <q-input
        readonly
        :model-value="props.TestEnv.LastModifiedUser"
